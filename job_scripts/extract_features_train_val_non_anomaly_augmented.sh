...
#SBATCH --output=train_val_non_anomaly_augmented_feature_extraction_output.out
...
extract_features "$BASE_INPUT/train_val/non_anomaly_augmented" "$BASE_OUTPUT/train_val/non_anomaly_augmented"
